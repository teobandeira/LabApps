...
export default function ChatGptModesPage() {
  return (
    <main className="font-(family-name:--font-montserrat) min-h-screen bg-gray-900 text-white">
      <section className="mx-auto w-full max-w-7xl px-0 pt-0 pb-8 sm:pt-0 lg:px-8 lg:pt-8 lg:pb-10">
        ...
        <section className="grid gap-4 px-4 sm:px-6 lg:px-0 md:grid-cols-2">
          {MODE_CARDS.map((card) => (
            <Link
              key={card.title}
              href={card.href}
